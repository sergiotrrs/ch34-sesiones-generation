...
--
-- Temporary view structure for view `edades`
--

DROP TABLE IF EXISTS `edades`;
/*!50001 DROP VIEW IF EXISTS `edades`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `edades` AS SELECT 
 1 AS `nombre`,
...
INSERT INTO `productos` VALUES (1,'Café Americano',50.00,1),(2,'Espresso',25.00,1),(3,'Matcha Latte',50.00,2),(4,'Chai Latte',55.00,2),(5,'Chocolate',45.00,2),(6,'Café Frappé',65.00,NULL),(7,'Oreo Frappé',65.00,NULL),(8,'Mocha Frappé',65.00,NULL),(9,'Sea Salt Caramel',60.00,NULL),(10,'Dark Horchata Ice',55.00,NULL),(11,'Bagel Clásico',65.00,4),(12,'Bagel Serrano',80.00,4),(13,'Bagel Dulce/Salado',40.00,4),(14,'Panini Italiano',70.00,5),(15,'Pizanini',70.00,5),(16,'Panini Vegetariano',90.00,5),(17,'Cuernito Clásico',65.00,6),(18,'Cuernito Italiano',65.00,6),(19,'Waffle Tradicional',80.00,7),(20,'Waffle con Helado o Fresas',90.00,7);
...
--
/*!50003 DROP PROCEDURE IF EXISTS `setFechaNacimiento` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `setFechaNacimiento`(IN idPersona LONG, IN newFechaNacimiento TIMESTAMP  )
BEGIN
...
--
-- Final view structure for view `edades`
--
...
/*!50001 VIEW `edades` AS select `usuarios`.`nombre` AS `nombre`,`usuarios`.`fecha_nacimiento` AS `fecha_nacimiento`,(to_days(curdate()) - to_days(`usuarios`.`fecha_nacimiento`)) AS `Días`,floor(((to_days(curdate()) - to_days(`usuarios`.`fecha_nacimiento`)) / 365)) AS `Años` from `usuarios` where (not((`usuarios`.`nombre` like '%Oswa%'))) */;
...
-- Dump completed on 2023-12-20 17:35:57
